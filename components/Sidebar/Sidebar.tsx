'use client'
import { FaBox,FaUsers,FaClipboardList,FaTruck,FaCog,FaChartLine,FaChartPie,FaPlusCircle,FaList,FaFileInvoiceDollar,FaExchangeAlt,FaShoppingCart,FaInfoCircle,FaReceipt,FaMoneyBillWave,FaReceipt as FaCashRegister,FaCalendarAlt,FaTools,FaFileMedical,FaPills,FaStethoscope,FaCalendarDay,FaCalendarPlus,FaBed,FaHeartbeat,FaHistory,FaUniversity,FaBook,FaUserTie,FaBalanceScale,FaBuilding,FaDatabase,FaKey,FaPuzzlePiece,FaProjectDiagram,} from 'react-icons/fa'
...
const sidebarData: SidebarItemType[] = [
    ...
    },
    {
      title: 'Pharmacy',
      children: [
        { title: 'Dashboard', path: '/Pharmacy/dashboard', icon: FaChartLine },
        {
          title: 'Report Summary',
          children: [
            { title: 'Summary 1', path: '/Pharmacy/report-summary/summary-1', icon: FaChartPie },
            { title: 'Summary 2', path: '/Pharmacy/report-summary/summary-2', icon: FaChartPie },
          ],
        },
        {
          title: 'Products',
          children: [
            { title: 'Add and view', path: '/Pharmacy/products/addandview', icon: FaPlusCircle },
          ],
        },
        {
          title: 'Suppliers',
          children: [
            { title: 'Add and view Supplier', path: '/master/suppliers', icon: FaPlusCircle },
          ],
        },
        {
          title: 'Customer',
          children: [
            { title: 'Add and view customer', path: '/master/customers', icon: FaPlusCircle },
          ],
        },
        {
          title: 'Invoices',
          children: [
            { title: 'Generate Invoice', path: '/Pharmacy/invoice/generate_invoice', icon: FaFileInvoiceDollar },
